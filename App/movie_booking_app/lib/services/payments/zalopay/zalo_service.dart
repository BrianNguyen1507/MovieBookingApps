...
import 'dart:convert';
import 'package:movie_booking_app/services/payments/zalopay/zalo_config.dart'
    as utils;
import 'package:movie_booking_app/services/payments/zalopay/create_order.dart';
...
Future<CreateOrderResponse?> createOrder(int price) async {
  ...
  try {
    ...
    debugPrint("body_request: $body");
    if (response.statusCode != 200) {
      return null;
    }

    final data = jsonDecode(response.body);
    debugPrint("data_response: $data");
